<?php
    ...
    function ChangeTelefone($id, $campo, $novoValor): ResultService {
        ...
        include($_SERVER['DOCUMENT_ROOT']."/ebbim-api/Repositories/Telefone/UpdateTelefone.php");

        $code = UpdateTelefone($id, $campo, $novoValor);
